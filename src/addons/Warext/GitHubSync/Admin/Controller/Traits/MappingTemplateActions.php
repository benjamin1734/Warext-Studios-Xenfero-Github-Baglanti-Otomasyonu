...
trait MappingTemplateActions
{
    ...
    public function actionMappingSave(ParameterBag $params)
    {
        ...
        $source=$this->filter(['xf_node_id'=>'uint','outbound_object'=>'str','sync_first_post'=>'bool','sync_replies'=>'bool','sync_thread_state'=>'bool','sync_labels'=>'bool']);
        ...
        $m->source_config=['xf_node_id'=>(int)$source['xf_node_id'],'outbound_object'=>$source['outbound_object']?:'issue','sync_first_post'=>(bool)$source['sync_first_post'],'sync_replies'=>(bool)$source['sync_replies'],'sync_thread_state'=>(bool)$source['sync_thread_state'],'sync_labels'=>(bool)$source['sync_labels']];
