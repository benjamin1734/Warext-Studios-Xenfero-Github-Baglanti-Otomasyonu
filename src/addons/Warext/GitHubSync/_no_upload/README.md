...
This directory contains development-only notes/tests. Repository-level English and Turkish documentation should be used for installation and architecture guidance.
